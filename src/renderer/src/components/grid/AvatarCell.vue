...
.avatar-cell {
  ...
  overflow: hidden;
  cursor: grab;
  transition: filter 0.35s ease, transform 0.3s cubic-bezier(0.34, 1.56, 0.64, 1), box-shadow 0.3s ease;
}
.avatar-cell:active { cursor: grabbing; }
.avatar-cell.is-dimmed { filter: brightness(0.3); }
...
.avatar-cell:hover .avatar-overlay { transform: translateY(0); }
.avatar-name { color: white; font-size: 0.75rem; font-weight: 600; }
.avatar-handle { color: rgba(255,255,255,0.7); font-size: 0.625rem; }
</style>
